/*
 * TaylorLineConfig.h
 * Configuration parameters for Taylor Line Microswimmer
 * Default values are from: Agrawal & Babu, Phys. Rev. E 97, 020401(R) (2018)
 */
...
// All parameters have default values from the paper
// Override any parameter by setting it in the config before passing to TaylorLine
